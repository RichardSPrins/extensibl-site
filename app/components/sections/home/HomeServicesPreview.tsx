...
export default function HomeServicesPreview() {
  return (
    <div className="container mx-auto px-6 md:px-0">
      <p className="text-3xl font-semibold lg:text-center">Services</p>
      <p className="lg:text-center text-4xl lg:text-5xl font-bold w-full lg:w-3/4 w-full mx-auto mt-4">
      ...
      <div className="flex mt-20 justify-around flex-col md:flex-row items-center md:items-start w-full">
        <div className="md:max-w-xs my-8">
          <MdBusiness className="text-6xl mb-4" />
        ...
        <div className="md:max-w-xs my-8">
          <MdMediation className="text-6xl mb-4" />
        ...
        <div className="md:max-w-xs my-8">
          <MdAutoGraph className="text-6xl mb-4" />
      ...
      <div className="flex w-full justify-center">
        <button className="my-4 h-16 bg-black text-white hover:bg-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">
          See More Services
          {" "}
          <FaArrowRight className="inline mb-1"/>
        </button>
      </div>
    </div>
  );
